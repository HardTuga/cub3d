...
/*   Updated: 2023/01/31 10:23:23 by lucas-ma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_gun(t_all *var)
{
	...
	"./assets/gun5.xpm", &var->tex[GUN5].img_width, &var->tex[GUN5].img_height);
	...
	"./assets/gun6.xpm", &var->tex[GUN6].img_width, &var->tex[GUN6].img_height);
	...
	"./assets/gun7.xpm", &var->tex[GUN7].img_width, &var->tex[GUN7].img_height);
	...
	"./assets/gun8.xpm", &var->tex[GUN8].img_width, &var->tex[GUN8].img_height);
	...
	"./assets/gun9.xpm", &var->tex[GUN9].img_width, &var->tex[GUN9].img_height);
...
void	init_door_image(t_all *var)
{
	...
	"./assets/gun1.xpm", &var->tex[GUN1].img_width, &var->tex[GUN1].img_height);
	...
	"./assets/gun2.xpm", &var->tex[GUN2].img_width, &var->tex[GUN2].img_height);
	...
	"./assets/gun3.xpm", &var->tex[GUN3].img_width, &var->tex[GUN3].img_height);
	...
	"./assets/gun4.xpm", &var->tex[GUN4].img_width, &var->tex[GUN4].img_height);
